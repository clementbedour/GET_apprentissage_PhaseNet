...
# ------------ ARGUMENTS VOLPICK ------------
if len(sys.argv) < 3:
    print("Erreur : Il manque des arguments. Utilisation : python extraire_nouv.py (1|2) (VT|LPVT)")
    sys.exit(1)
...
OUTPUT_DATASET_DIR = os.path.join(BASE_DIR, DOSSIER_QUALITE, f"volpick_dataset_{event_type}_gold_V{mode_modele}")

print(f"--- Lancement Extraction : Modèle V{mode_modele} | Événement '{event_type}' ---")
# -----------------------------------------
...
OLD_DATASET_DIR = os.path.join(BASE_DIR, DOSSIER_QUALITE, f"volpick_dataset_{event_type}")
