...
script -q -c "sshpass -p '$MDP' scp ../prg_python/association_pyocto.py clov@nuwa.aero.obs-mip.fr:/home/clov/seisbench_VT/prg_python" /dev/null
...
script -q -c "sshpass -p '$MDP' scp ../prg_python/loss_curve.py clov@nuwa.aero.obs-mip.fr:/home/clov/seisbench_VT/prg_python" /dev/null
...
script -q -c "sshpass -p '$MDP' scp ../prg_python/compare_noise.py clov@nuwa.aero.obs-mip.fr:/home/clov/seisbench_VT/prg_python" /dev/null
